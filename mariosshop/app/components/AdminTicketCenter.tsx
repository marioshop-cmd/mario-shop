...
interface AdminTicketCenterProps {
  ...
  paneHeight?: string;
  /** When set, only tickets in this category are shown — used to build a
   * dedicated dashboard (e.g. just "Payment & Billing") instead of the
   * full support inbox. */
  categoryFilter?: Ticket['category'];
}
...
export default function AdminTicketCenter({
  paneHeight = 'min-h-[520px] max-h-[70vh]',
  categoryFilter,
}: AdminTicketCenterProps) {
