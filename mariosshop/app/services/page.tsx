      ...
      {selectedProduct ? (
        <div className="space-y-10 animate-fadeIn">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 bg-zinc-950/60 backdrop-blur-md border border-zinc-800/60 rounded-3xl p-6 md:p-8">
              ...
              <div className="space-y-6">
                <div>
                  {selectedBrand?.category && (
                    <span className="text-[10px] font-bold uppercase tracking-wider px-2.5 py-1 bg-zinc-900 text-zinc-400 border border-zinc-800 rounded-lg mr-2">
            ...
            <div className="lg:col-span-5 relative h-[420px] bg-zinc-950 border border-zinc-800/80 rounded-2xl overflow-hidden">
              <img
