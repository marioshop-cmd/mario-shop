  ...
  if (!currentUser) {
    return (
      <main className="flex min-h-screen flex-col items-center justify-center gap-3 bg-zinc-950 px-4 text-center text-white">
        <p className="text-xs text-zinc-400">You need to be logged in to view your orders.</p>
        <Link
          href="/login"
      ...
      <div className="mx-auto max-w-3xl space-y-6">
        <div className="flex flex-wrap items-end justify-between gap-3">
          <div>
            ...
            <p className="text-xs text-zinc-400">Track the progress of everything you've bought.</p>
          </div>
          <Link
            href="/services"
        ...
        {orders.length === 0 ? (
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/50 p-10 text-center">
            ...
            <p className="mt-1 text-xs text-zinc-500">
              ...
              and your purchases will show up here.
            </p>
          </div>
        ) : (
              ...
              return (
                <div key={order.id} className="rounded-2xl border border-zinc-800 bg-zinc-900/60 p-5 space-y-4">
                  ...
                  <div className="border-t border-zinc-800 pt-3">
                    ...
                    >
                      💬 {isExpanded ? 'Hide' : 'Message us about this order'}
                      {messageCount > 0 && (
                      ...
                      <div className="mt-3 space-y-3 rounded-xl border border-zinc-800 bg-zinc-950 p-3">
                        {messages.length === 0 ? (
                          <p className="text-center text-[11px] text-zinc-600">
                            No messages yet. Need to share your account email for a subscription, or ask something? Send it below.
                          </p>
                        ) : (
                        ...
                        <div className="flex gap-2">
                          <textarea
                            ...
                            rows={2}
                            placeholder="Type a message… (e.g. your account email for this subscription)"
