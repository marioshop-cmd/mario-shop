      ...
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        <section className="text-center space-y-3 max-w-3xl mx-auto">
          ...
          <h1 className="text-3xl md:text-5xl font-black tracking-tight">
            Invite Friends, Earn <span className="text-red-500">Store Credit</span>
          </h1>
          <p className="text-zinc-400 text-sm md:text-base leading-relaxed">
            Share your unique referral code or link with friends to earn balance for Mario's Shop.
          </p>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-zinc-900/80 border border-zinc-800/80 rounded-2xl p-6 text-center space-y-2 flex flex-col items-center justify-center backdrop-blur-md">
            ...
            <div className="text-xs font-bold text-zinc-400 uppercase tracking-wider">Total Referrals</div>
          </div>
          ...
          <div className="bg-zinc-900/80 border border-zinc-800/80 rounded-2xl p-6 text-center space-y-2 flex flex-col items-center justify-center backdrop-blur-md">
            ...
            <div className="text-xs font-bold text-zinc-400 uppercase tracking-wider">Total Earnings</div>
          </div>
          ...
          <div className="bg-zinc-900/80 border border-zinc-800/80 rounded-2xl p-6 text-center space-y-2 flex flex-col items-center justify-center backdrop-blur-md">
            ...
            <div className="text-xs font-bold text-zinc-400 uppercase tracking-wider">Your Code</div>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-2">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-xs md:text-sm text-zinc-300">
                <li className="flex items-start gap-2.5">
                  ...
                  <span><strong className="text-white">2 DT store credit</strong> when your friend makes their first purchase (min 10 DT order)</span>
                </li>
                ...
                <li className="flex items-start gap-2.5">
                  ...
                  <span>Your friend gets <strong className="text-white">1 DT welcome credit</strong> on signup</span>
                </li>
                ...
                <li className="flex items-start gap-2.5">
                  ...
                  <span>Store credit can be used at checkout on any product</span>
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2.5 text-xs md:text-sm text-zinc-400 list-disc list-inside leading-relaxed">
                <li>Friend must purchase within 30 days of signing up</li>
                <li>Monthly earnings capped at 30 DT per referrer</li>
                <li>Self-referrals and duplicate accounts are not allowed</li>
                <li>One referral per device/IP address</li>
              </ul>
            </div>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          {/* STEP 1 */}
          <div className="group bg-zinc-900/60 border border-zinc-800/80 rounded-2xl p-6 relative overflow-hidden transition-all duration-300 hover:border-red-500/40">
            ...
            <h3 className="text-lg font-bold text-white mb-2">Share Code</h3>
            <p className="text-xs text-zinc-400 leading-relaxed">
              Copy your referral link or code above and share it with your friends.
            </p>
          </div>
          ...
          <div className="group bg-zinc-900/60 border border-zinc-800/80 rounded-2xl p-6 relative overflow-hidden transition-all duration-300 hover:border-red-500/40">
            ...
            <h3 className="text-lg font-bold text-white mb-2">Friend Signs Up</h3>
            <p className="text-xs text-zinc-400 leading-relaxed">
              Your friend registers and gets a 1 DT bonus added instantly to their account.
            </p>
          </div>
          ...
          <div className="group bg-zinc-900/60 border border-zinc-800/80 rounded-2xl p-6 relative overflow-hidden transition-all duration-300 hover:border-red-500/40">
            ...
            <h3 className="text-lg font-bold text-white mb-2">Get Store Credit</h3>
            <p className="text-xs text-zinc-400 leading-relaxed">
              Earn 2 DT credit automatically when they complete their first order of 10 DT or more.
            </p>
          </div>
